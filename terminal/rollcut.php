...
<body>
					...
					<div class="card-body">
						...
						?>
							...
							<?php
								...
								$entry_screen = true;
							?>
								<form class="form-horizontal" id="rollcut_form" method="POST" action="inspect_entry_act.php">
									<input type="hidden" name="length" value="<?php echo $length; ?>" />
									<input type="hidden" name="inspect_entry_act" value="rollcut" />
										...
										<div class="row">
											<div class="col-6">
												...
												<div class="form-group">
													<span class="screen_title">ROLL CUT- <?php echo $screen_title; ?></span>
												</div>
													...
													<!-- Marquee HTML -->
												<marquee direction="left" behavior="alternate" class="text-primary" style="border:none;">
													<h3>
														<?php
														for ($i = 1; $i < 10; $i++) {
															echo '<i class="fa fa-scissors" aria-hidden="true"></i>';
															echo '<span>&nbsp; --- &nbsp;</span>';
														}
														echo '<i class="fa fa-scissors" aria-hidden="true"></i>';
														?>
											...
											<div class="col-6">
												...
												<div class="row">
													...
													<div class="col-6">
														<div class="option_key" id="rollcut_btn" data-bs-toggle="modal" data-bs-target="#confirmmodal" style="text-align:center; background-color:green; border-color:green">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title text-primary" id="confirmmodalLabel"><i class="fa fa-scissors" aria-hidden="true"></i> ROLL CUT <i class="fa fa-scissors" aria-hidden="true"></i></h5>
				</div>
				<div class="modal-body">
					Do you really want to cut this roll?
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
					<button type="button" class="btn btn-success" id="confirm_btn"><i class="fa fa-scissors" aria-hidden="true"></i> Confirm</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		$('#confirm_btn').click(function(e) {
			...
			$('#rollcut_form').find('input, select, textarea').each(function() {
				var thisinput = $(this);
			...
			if (errorexist == true) {
				...
				$('#rollcut_form').find('[type="submit"]').trigger('click');
			}
		});
