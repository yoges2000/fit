...
(function (factory) {
	...
	/*!
	  ...
	  * Copyright 2011-2021 The Bootstrap Authors (http://localhost/dlog/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (http://localhost/dlog/twbs/bootstrap/blob/main/LICENSE)
	  */
