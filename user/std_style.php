        ...
        <div class="card">
                  ...
                  <?php
                        ...
                        <div class="form-cotainer">
							<form class="form-horizontal" method="post" action="../actions/std_style_act.php">
								
								<div class="row">
								    <input type="hidden" name="style_id" value="<?php echo $style_id; ?>" >
									<div class="col-md-2 col-sm-12">
                              			<label class="form-label">Style Name</label>
                              			<input type="text" class="form-control" name="style" value="<?php echo $style; ?>" required>
                            		</div>
                            		<div class="col-md-2 col-sm-12">
                              			<label class="form-label">Construction</label>
                              			<input type="text" class="form-control" name="descr" value="<?php echo $descr; ?>" required>
                            		</div>
