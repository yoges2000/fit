...
<body>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<table id="example" class="responsiveTbl">
								...
								<tbody>
									<?php
									$qry = "SELECT * FROM ROLL where ROLL_END=0 AND ROll_APPROVE = 1 ORDER BY ROLL_INSP_DATE DESC LIMIT 1000";
									...
									?>
											...
											<td><a  href="std_stylechg.php?edit_id=<?php echo $roll_id; ?>"><?php echo GFV("STDSTYLE", "style", "STYLE_ID='$ROLL_BATCHID'"); ?></a></td>
											<td><?php echo GFV("STDSTYLE", "descr", "STYLE_ID='$ROLL_BATCHID'"); ?></td>
											<td><?php echo $roll_length; ?></td>
											<td class="center">
												<div id="approve_btn" data-id="<?php echo $roll_id; ?>" class="btn btn-success btn-mini" style="background-color:Red;">Un Approve</div>
											</td>
	...
	<div class="modal fade" id="confirmBox">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div style="padding:20px"><input type="text" id="remark" name="remark"> Remark</input>
	...
	<script>
		...
		$(document).on('click', '#approve_btn', function(e) {
			...
			doConfirm("Approval?", "Are you sure want to Un approve the Roll.", function yes() {
				var remark=$("#remark").val();
				//alert(id);
				$.ajax({
					type: "POST",
					url: '../actions/approval_act.php?remark=<?php echo $remark; ?>"',
					data: {
						"roll_id": id,
						"remark": remark,
						"action": '0'
					...
					success: function(result) {
						...
						if (response.success) {
							...
							alert('Roll Un approved successfully');
						} else {
							alert('Failed to Un approve roll');
						}
						location.reload();
					},
