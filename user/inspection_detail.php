...
$page_group = 'reports';
$title = 'Inspection Detailed Report ';
?>
							...
							<div class="col-md-4 col-sm-12" id="from_date">
                             ...
                             <div class="col-md-4 col-sm-12">
                              			...
                              			<select class="form-control select2-icon" name="sortby" id="sortby" onchange="getsortby()">
                              		 		  <option value="Machine" <?php if($sortby == 'Machine'){echo 'selected';} ?>>Machine</option>
                               				  <option value="Style" <?php if($sortby == 'Style'){echo 'selected';} ?>>Style</option>
                               				  <option value="Inspector" <?php if($sortby == 'Inspector'){echo 'selected';} ?>>Inspector</option>
                               				   <option value="Roll" <?php if($sortby == 'Roll'){echo 'selected';} ?>>Roll</option>
                                         </select>
                            	</div>
			...
			var period=$("#period").val();
			 ...
			 $('#displayreport').hide();
				$.ajax({
					...
					url:"../ajax/inspection_detail_data.php",

					data:{'period':period,'date1':date1,'date2':date2,'sortby':sortby,'selectdata':selectdata,'type':type},
